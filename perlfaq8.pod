...
=head2 Where do I get the include files to do ioctl() or syscall()? What is a .ph file?
...
For many standard header files these conversions are alread part of the
standard perl distribution (e.g C<Socket>, C<Errno>). Modern programs
use these in preference of .ph files.
