...
Ingy dE<ouml>t Net's C<Inline> module for embedding foreign code in a
Perl program.  The most popular use of Inline is C<Inline::C>, which
provides a cleaner and simpler way to interface with C programs,
compared to h2xs or SWIG.
...
Open Source Software.  Perl is open source and is often mentioned in
connection with the OSS movement.
...
A lively list for the discussion of the Perl 6 language design.  Not
...
technical nature of Perl.  Composed of geographically localized groups,
